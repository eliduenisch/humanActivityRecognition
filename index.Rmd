...
The data used in this project is available for download from this website: [http://groupware.les.inf.puc-rio.br/har].
* the training data set: [https://d396qusza40orc.cloudfront.net/predmachlearn/pml-training.csv]
* the test data set: [https://d396qusza40orc.cloudfront.net/predmachlearn/pml-testing.csv]
